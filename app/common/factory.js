module.exports = angular.module('lkApp.service',[])
    .factory('Http', ['$http', '$q', '$cookies', 'APP_CONFIG', function ($http, $q, $cookies, APP_CONFIG) {
        ...
        Http.prototype._getUrl = function (url) {
            ...
            !_.isUndefined(this._apiName) && arr.push(this._apiName);
            !_.isUndefined(url) && arr.push(url);
