class ViewTeachingResourcesCtrl {
...
ViewTeachingResourcesCtrl.$inject = ['$scope', 'APP_CONFIG', '$uibModalInstance', 'items', 'toastr'];

module.exports = (ngMold) => {
    ngMold.controller('viewTeachingResourcesCtrl', ViewTeachingResourcesCtrl);
}