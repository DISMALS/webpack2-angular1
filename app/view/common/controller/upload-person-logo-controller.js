...
UploadPersonLogoCtrl.$inject = ['$scope', 'APP_CONFIG', '$uibModalInstance', 'items', 'toastr'];

module.exports = (ngMold) => {
    require('../directive/upload-person-logo-directive')(ngMold);
    ngMold.controller('uploadPersonLogoCtrl', UploadPersonLogoCtrl);
}