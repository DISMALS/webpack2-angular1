let DryadPermissionCheck = ($rootScope, $timeout, $parse, _, mainService) => {
    ...
    return {
        ...
        controller: ['$scope', '$location', '$state', 'mainService', function($scope, $location, $state, mainService) {
            // console.log('Controller', arguments);
            $scope.userAuthorities = mainService.getCurrentUserAuthorities(); //, "OPERATING_PERMISSION", "EXPERTS_PERMISSION"
        }],
...
DryadPermissionCheck.$inject = ['$rootScope', '$timeout', '$parse', '_', 'mainService'];
