...
DataBaseinfoCtrl.$inject = ['$scope', '$stateParams', '_', 'medicalService','toastr','$cookies','$rootScope','$state','$uibModal']
module.exports = (ngMold) => {
     require.ensure(['../../patients/service/patients-service.js'], (require) => {
        require('../../patients/service/patients-service.js')(ngMold);
    }, './patients/patients-service.js');
