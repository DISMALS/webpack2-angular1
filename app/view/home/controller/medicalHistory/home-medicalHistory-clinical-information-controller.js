class MedicalHistoryClinicalInformationCtrl {
...
MedicalHistoryClinicalInformationCtrl.$inject = ['$scope', '$stateParams','medicalService'];
...
module.exports = (ngMold) => {
    ...
    ngMold.controller('medicalHistoryClinicalInformationCtrl', MedicalHistoryClinicalInformationCtrl);
}