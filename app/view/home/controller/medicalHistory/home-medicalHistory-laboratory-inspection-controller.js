class MedicalHistoryLaboratoryInspectionCtrl {
...
MedicalHistoryLaboratoryInspectionCtrl.$inject = ['$scope', '$uibModal','medicalService','conmmonService','$q','$cookies'];
...
module.exports = (ngMold) => {
    ...
    ngMold.controller('medicalHistoryLaboratoryInspectionCtrl', MedicalHistoryLaboratoryInspectionCtrl);
}