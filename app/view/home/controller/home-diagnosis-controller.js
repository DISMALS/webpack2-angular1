...
HomeDiagnosisCtrl.$inject = ['$rootScope', '$scope', '$stateParams', 'PatientsService','$uibModal','toastr'];
...
module.exports = (ngMold) => {
    ...
    ngMold.controller('homeDiagnosisCtrl', HomeDiagnosisCtrl);
}