    ...
    constructor($scope, $state, $stateParams, $uibModal) {
        ...
        $scope.gridOptions = {
            ...
            fields: [{
                ...
                { name: "Name", title: '区域中心名称', type: "text", width: 65, align: 'center' },
                { name: "Sex", title: '下辖省份', type: "text", width: 120, align: 'center' },
                { name: "Age", title: '区域中心说明', type: "text", width: 140, align: 'center' },
                {
                    title: '操作',
                    type: "control",
                    align: 'center',
...
SystemRegionalCenterCtrl.$inject = ['$scope', '$state', '$stateParams', '$uibModal'];
