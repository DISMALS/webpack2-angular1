    ...
    constructor($scope, $state, $stateParams, $uibModal) {
        ...
        $scope.gridOptions = {
            ...
            fields: [{
                ...
                { name: "Sex", title: '性别', type: "text", width: 30, align: 'center' },
                { name: "Age", title: '年龄', type: "text", width: 30, align: 'center' },
                { name: "Address", title: '科室', type: "text", width: 80, align: 'center' },
                { name: "Role", title: '角色', type: "text", width: 50, align: 'center' },
                { name: "Work", title: '职称', type: "text", width: 50, align: 'center' },
        ...
        $scope.editeAdd = (item, type) => {
            if(type == 'edit'){
                $state.go('dryad.system.institutional-management.details', { id: 2333 });
            }else{
        ...
        //查看
        $scope.view = (item) => {
            $state.go('dryad.system.institutional-management.view', { id: 2666 });
        };
...
SystemEmployeeCtrl.$inject = ['$scope', '$state', '$stateParams', '$uibModal'];
